...
def test_multisend_transient_ether(chain):
    ...
    mscode = '0x' + '602060566060395b6060511560545760206060510260206056010160405260206040516080396020806040510160a03960008060008060a051608051617530f1604757600080fd5b6001606051036060526007565b00'
